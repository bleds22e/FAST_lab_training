...
Once you've done this, be sure to install the packages and data. 
...
### Dugout Data
We'll be using some dugout data from 2017 during these sessions. You can find the .csv file [here](). Alternatively, it is in this repository (above) in the "data" folder. First,
